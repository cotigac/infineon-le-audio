...
set(CMAKE_C_COMPILER "${TOOLCHAIN_BIN_DIR}${TOOLCHAIN_PREFIX}gcc${TOOL_EXT}")
set(CMAKE_CXX_COMPILER "${TOOLCHAIN_BIN_DIR}${TOOLCHAIN_PREFIX}g++${TOOL_EXT}")
set(CMAKE_ASM_COMPILER "${TOOLCHAIN_BIN_DIR}${TOOLCHAIN_PREFIX}gcc${TOOL_EXT}")
set(CMAKE_OBJCOPY "${TOOLCHAIN_BIN_DIR}${TOOLCHAIN_PREFIX}objcopy${TOOL_EXT}")
set(CMAKE_OBJDUMP "${TOOLCHAIN_BIN_DIR}${TOOLCHAIN_PREFIX}objdump${TOOL_EXT}")
set(CMAKE_SIZE "${TOOLCHAIN_BIN_DIR}${TOOLCHAIN_PREFIX}size${TOOL_EXT}")
set(CMAKE_AR "${TOOLCHAIN_BIN_DIR}${TOOLCHAIN_PREFIX}ar${TOOL_EXT}")
set(CMAKE_RANLIB "${TOOLCHAIN_BIN_DIR}${TOOLCHAIN_PREFIX}ranlib${TOOL_EXT}")
set(CMAKE_NM "${TOOLCHAIN_BIN_DIR}${TOOLCHAIN_PREFIX}nm${TOOL_EXT}")
set(CMAKE_STRIP "${TOOLCHAIN_BIN_DIR}${TOOLCHAIN_PREFIX}strip${TOOL_EXT}")
