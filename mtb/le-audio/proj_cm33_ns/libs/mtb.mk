...
SEARCH_kv-store=$(patsubst %/,%,$(CY_GETLIBS_SHARED_PATH))/$(CY_GETLIBS_SHARED_NAME)/kv-store/release-v2.2.0
...
SEARCH_block-storage=$(patsubst %/,%,$(CY_GETLIBS_SHARED_PATH))/$(CY_GETLIBS_SHARED_NAME)/block-storage/release-v1.3.2
