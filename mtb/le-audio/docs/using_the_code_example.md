...
The following example clones the "[Bluetooth&reg; LE ISOC Peripheral](https://github.com/Infineon/mtb-example-psoc-edge-btstack-isoc-peripheral)" application with the desired name "IsocPeripheral" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-btstack-isoc-peripheral --user-app-name IsocPeripheral --target-dir "C:/mtb_projects"
   ```
